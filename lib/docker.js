...
module.exports = {
    ...
    stop: function(gorillaFile){
        ...
        if(fs.existsSync(gorillaFile)){
            ...
            cross.exec('docker stop $(docker ps -aq --filter="name=' + data.local.project.domain + '") && docker rm $(docker ps -aq --filter="name=' + data.local.project.domain + '")', function(err, stdout, stderr){
