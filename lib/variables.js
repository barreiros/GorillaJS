...
module.exports = {
    ...
    combinations: {
        ...
        'docker': {
            // 'template_type': ['Django', 'PHP-7', 'NodeJS', 'Opencart', 'Wordpress', 'External repository', 'Local folder']
            'template_type': ['Wordpress', 'PHP-7', 'Django', 'NodeJS', 'External repository', 'Local folder']
        }
