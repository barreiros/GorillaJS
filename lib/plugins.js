        ...
        if(argv._[0] === 'plugin'){
            ...
            if(argv._[1] === 'add' && argv._[2]){
                ...
                promisesPack = [
                    ...
                    [tools.track, ['PluginAdd', argv._[2], '', 6]]
                ...
                tools.track('PluginRemove', argv._[2], '', 7);
...
function downloadFile(serverData){
    ...
    s3.getObject({
        ...
        if(err){
            ...
            cross.exec('tar zxvf ' + path.join(envPaths.plugins, serverData.key) + ' -C ' + envPaths.plugins, function(err, stdout, stderr){
