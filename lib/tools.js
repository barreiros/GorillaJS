...
module.exports = {
    ...
    createTemplateEnvironment: function(projectPath, templatesPath, template, gorillaFolder, gorilla, messagesFile){
        ...
        cross.moveFiles(templatesPath + '/common', projectPath + '/' + gorillaFolder, false, ['.DS_Store']);
        cross.moveFiles(templatesPath + '/' + template, projectPath + '/' + gorillaFolder, false, ['.DS_Store']);
    ...
    removeDir: function(path){
        ...
        cross.execSync('rm', ['-r', path], function(err, stdout, stderr){
    ...
    param: function(step, name, options, filter){
        ...
        if(promises.length > 0){
            ...
            if(typeof promise === 'function'){
                ...
                if(typeof promise[1] === 'object'){
                    promise[0].apply(this, promise[1]);
                }else{
                    promise[0](promise[1]);
                }
            }
    ...
    fusionObjectNodes: function(object, node1, node2){
    ...
    filterPaths: function(paths, subtract){
