...
module.exports = function (env){
    ...
    module.createGorillaEnvironment = function(projectPath, templatesPath, gorilla, gorillaFolder){
    ...
    module.param = function(step, name){
        ...
        if(exist){
            ...
            if(name.indexOf('pass') > -1){
                value = prompt.question('Value for ' + step + ' ' + name + ': ', {hideEchoBack: true});
            }else{
                value = prompt.question('Value for ' + step + ' ' + name + ': ', {});
            }
        }
