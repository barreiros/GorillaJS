...
function createTemplateEnvironment(projectPath, gorillaFolder, gorilla, messagesFile, templateFolder){
    ...
    messagesFileTemplate = projectPath + '/' + gorillaFolder + '/' + templateFolder + '/' + messagesFile;
    ...
    gorillaFileDocker = projectPath + '/' + gorillaFolder + '/' + templateFolder + '/' + gorilla;
...
function getPlatform(){
    ...
    cross.exec('uname -s', function(err, stdout, stderr){
        ...
        events.publish('PROMISEME', platform);
