...
module.exports = {
    ...
    removeDir: removeDir,
    setEnvVariable: setEnvVariables,
...
function setEnvVariables(paths){
...
function createTemplateEnvironment(projectPath, templatesPath, template, gorillaFolder, gorilla, messagesFile){
