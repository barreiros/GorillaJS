...
module.exports = function (env){
    ...
    module.createTemplateEnvironment = function(projectPath, templatesPath, template, gorillaFolder, gorilla, messagesFile){
        events.publish('STEP', ['tools-createtemplate']);

        var messagesFileTemplate, gorillaFileDocker, configDocker, messagesTemplate;

        module.moveFiles([templatesPath + '/' + template, projectPath + '/' + gorillaFolder]);
