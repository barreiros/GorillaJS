...
module.exports = {
    ...
    initRepo: function(args){
        ...
        exec('git init', function(err, stdout, stderr){
            ...
            exec('git remote add origin ' + args[0], function(err, stdout, stderr){
    ...
    createRemote: function(args){
        ...
        if(args[0] === 'github'){
            ...
            exec('curl --header "PRIVATE-TOKEN: ' + args[1] + '" -X POST "https://gitlab.com/api/v3/projects?name=' + args[4] + '&public=' + !args[3] + '"', function(err, stdout, stderr){
