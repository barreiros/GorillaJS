...
inline
aybeLocal<v8::String> ToDetailString(v8::Handle<v8::Value> val) {
  return MaybeLocal<v8::String>(val->ToDetailString());
}

inline
aybeLocal<v8::Uint32> ToArrayIndex(v8::Handle<v8::Value> val) {
  return MaybeLocal<v8::Uint32>(val->ToArrayIndex());
}

inline
aybe<bool> Equals(v8::Handle<v8::Value> a, v8::Handle<v8::Value>(b)) {
  return Just<bool>(a->Equals(b));
}

inline
aybeLocal<v8::Object> NewInstance(v8::Handle<v8::Function> h) {
...
inline
aybeLocal<v8::Object> NewInstance(v8::Handle<v8::ObjectTemplate> h) {
  return MaybeLocal<v8::Object>(h->NewInstance());
}

inline
aybeLocal<v8::Function> GetFunction(v8::Handle<v8::FunctionTemplate> t) {
...
inline
aybeLocal<v8::Array> GetPropertyNames(v8::Handle<v8::Object> obj) {
  return MaybeLocal<v8::Array>(obj->GetPropertyNames());
}

inline
aybeLocal<v8::Array> GetOwnPropertyNames(v8::Handle<v8::Object> obj) {
...
inline
aybeLocal<v8::String> GetSourceLine(v8::Handle<v8::Message> msg) {
