...
inline
aybeLocal<v8::String> ToDetailString(v8::Local<v8::Value> val) {
  return val->ToDetailString(GetCurrentContext());
}

inline
aybeLocal<v8::Uint32> ToArrayIndex(v8::Local<v8::Value> val) {
  return val->ToArrayIndex(GetCurrentContext());
}

inline
aybe<bool> Equals(v8::Local<v8::Value> a, v8::Local<v8::Value>(b)) {
  return a->Equals(GetCurrentContext(), b);
}

inline
aybeLocal<v8::Object> NewInstance(v8::Local<v8::Function> h) {
  return h->NewInstance(GetCurrentContext());
}

inline
aybeLocal<v8::Object> NewInstance(
...
inline
aybeLocal<v8::Object> NewInstance(v8::Local<v8::ObjectTemplate> h) {
  return h->NewInstance(GetCurrentContext());
}
...
inline
aybeLocal<v8::Value> Get(v8::Local<v8::Object> obj, uint32_t index) {
...
inline
aybe<bool> Delete(v8::Local<v8::Object> obj, uint32_t index) {
  return obj->Delete(GetCurrentContext(), index);
}

inline
aybeLocal<v8::Array> GetPropertyNames(v8::Local<v8::Object> obj) {
  return obj->GetPropertyNames(GetCurrentContext());
}

inline
aybeLocal<v8::Array> GetOwnPropertyNames(v8::Local<v8::Object> obj) {
...
inline
aybeLocal<v8::String> GetSourceLine(v8::Local<v8::Message> msg) {
